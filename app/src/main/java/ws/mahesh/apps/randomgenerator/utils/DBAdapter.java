...
public class DBAdapter {
    ...
    public static final String[] ALL_KEYS = new String[]{KEY_ROWID, KEY_NAME, KEY_PASSWORD, KEY_TIMESTAMP};
    // TODO: Setup your field numbers here (0 = KEY_ROWID, 1=...)
    public static final int COL_NAME = 1;
    public static final int COL_PASSWORD = 2;
    public static final int COL_TIMESTAMP = 3;
    // DB info: it's name, and the table we are using (just one).
    public static final String DATABASE_NAME = "PassGen";
    ...
    public long insertRow(String name, String password, String timeStamp) {
        /*
		 * CHANGE 3:
		 */
    ...
    public boolean updateRow(long rowId, String name, String password, String timeStamp) {
        String where = KEY_ROWID + "=" + rowId;
